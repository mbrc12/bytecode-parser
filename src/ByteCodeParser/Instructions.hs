...
opIfs =
  [165, 166, 159, 160, 161, 162, 163, 164, 153, 154, 155, 156, 157, 158, 199]
    ...
    then case opcode of
           ...
           170 -- tableswitch
            -> do
             ...
             return
               ( ( pos
                 , [opcode, d1, d2, d3, d4, l1, l2, l3, l4, h1, h2, h3, h4] ++
                   manyMore)
               , pos + 1 + padding + 12 + toRead)
           171 -- lookupswitch
            -> do
             let padding = toFour pos
             ...
             manyMore <- replicateM toRead getWord8
             return
               ( (pos, [opcode, d1, d2, d3, d4, n1, n2, n3, n4] ++ manyMore)
